...
namespace CaioCavalcante_atividadePratica.Controllers
{
    public class DestinoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdDestino,NomeDestino,Preco,DataViagem")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDestino,NomeDestino,Preco,DataViagem")] Destino destino)
        {
